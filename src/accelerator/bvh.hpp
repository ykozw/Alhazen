...
public:
    ...
    virtual bool intersect(
        const Ray& ray,
        _Inout_ Intersect* isect) const = 0;
    virtual bool intersectCheck(
...
public:
    ...
    bool intersect(
        const Ray& ray,
        _Inout_ Intersect* isect) const override;
...
{
    // SIMD化された頂点
    __m128 x[3]; // (t1x1, t2x1, t3x1, t4x1) (t1x2, t2x2, t3x2, t4x2) (t1x3, t2x3, t3x3, t4x3)
    __m128 y[3]; // (t1y1, t2y1, t3y1, t4y1) (t1y2, t2y2, t3y2, t4y2) (t1y3, t2y3, t3y3, t4y3)
    __m128 z[3]; // (t1z1, t2z1, t3z1, t4z1) (t1z2, t2z2, t3z2, t4z2) (t1z3, t2z3, t3z3, t4z3)
    // 頂点位置 (t1x1, t1x2, t1x3) (t2x1, t2x2, t2x3) (t3x1, t3x2, t3x3)
    std::array<std::array<Vec3, 3>, 4> v;
    // 法線 (t1x1, t1x2, t1x3) (t2x1, t2x2, t2x3) (t3x1, t3x2, t3x3) (t4x1, t4x2, t4x3)
...
private:
    void constructNodeMedian(int32_t nodeIndex, RefArray<QBVHBuildTriangle>& tris, int32_t depth, int32_t& progress);
    void constructNodeSAH(int32_t nodeIndex, RefArray<QBVHBuildTriangle>& tris, int32_t depth, int32_t& progress);
private:
    std::vector<Vec3> vs_;
    std::vector<MeshFace> fs_;
