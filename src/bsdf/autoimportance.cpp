...
-------------------------------------------------
*/
void AutoImportance::genDistribution(float coso, const BSDF* bsdf,
...
-------------------------------------------------
*/
void AutoImportance::sample(Vec3 localWo, XorShift128& rng, _Out_ Vec3* localWi,
  ...
  int32_t offsetU;
  int32_t offsetV;
  dist2d.sample(rng.nextFloat(), rng.nextFloat(), pdf, &samplePointOrig,
                &offsetU, &offsetV);
  Vec2 samplePoint;
