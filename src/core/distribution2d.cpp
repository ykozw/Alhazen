...
-------------------------------------------------
*/
Distribution2D::Distribution2D(const float* values, int32_t raw,
                               int32_t column) {
  std::vector<std::vector<float>> tmp;
...
-------------------------------------------------
*/
void Distribution2D::sample(float u, float v, _Out_ float* pdf,
                            _Out_ Vec2* samplePoint, int32_t* offsetU,
