...
-------------------------------------------------
*/
int32_t FloatStreamStats::size() const
{
    return int32_t(n_);
}
...
-------------------------------------------------
*/
float FloatStreamStats::mean() const
{
    return mean_;
}
...
-------------------------------------------------
*/
float FloatStreamStats::variance() const
{
    return M_ / (n_ - 1.0f);
}
...
-------------------------------------------------
*/
float FloatStreamStats::sigma() const
{
...
-------------------------------------------------
*/
float FloatStreamStats::max() const
{
    return max_;
}
...
-------------------------------------------------
*/
float FloatStreamStats::min() const
{
    return min_;
}
...
-------------------------------------------------
*/
bool FloatStreamStats::maybeSameMean(const FloatStreamStats& lhs, const FloatStreamStats& rhs)
{
...
-------------------------------------------------
*/
int32_t FloatStreamStats2::size() const
{
    return int32_t(n_);
}
...
-------------------------------------------------
*/
float FloatStreamStats2::cov() const
{
    return cov_;
}
