...
-------------------------------------------------
*/
void ObjectProp::addAttribute(const std::string& tag,
...
void registerObject(
    ...
    const std::type_index& targetClassType, const std::string& baseClassName,
    const std::string& targetClassName,
    std::function<Object*(const ObjectProp&)> createObjectFunc) {
  logging("registerObject[%s:%s]", baseClassName.c_str(),
...
Object* createObjectCore(std::type_index baseClassType,
                         ...
                         const ObjectProp& objectProp) {
  //
  logging("Create Object[%s::%s]", baseClassType.name(),
          targetClassName.c_str());
  //
