...
class ObjectProp AL_FINAL {
 ...
 public:
  ...
  ObjectProp(const std::string& tag, const std::string& name,
...
-------------------------------------------------
*/
void registerObject(const std::type_index& baseClassType,
...
Object* createObjectCore(std::type_index baseClass,
  ...
  class Register##CLASS_TYPE##CLASS_NAME {                        \
   public:                                                        \
    Register##CLASS_TYPE##CLASS_NAME() {                          \
      registerObject(typeid(BASE_CLASS_TYPE), typeid(CLASS_TYPE), \
                     #BASE_CLASS_TYPE, #CLASS_TYPE, create);      \
    }                                                             \
