...
*/
Matrix4x4
Transform::constructToWorldMatrix(const ObjectProp& objectProp) const
{
    Matrix4x4 toWorld;
...
*/
const Vec3
Transform::toWorld(Vec3 pos) const
{
...
*/
const Vec3
Transform::toLocal(Vec3 pos) const
{
...
*/
const Vec3
Transform::toWorldDir(Vec3 dir) const
{
...
*/
const Vec3
Transform::toLocalDir(Vec3 dir) const
{
