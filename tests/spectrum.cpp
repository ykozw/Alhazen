...
-------------------------------------------------
*/
TEST_CASE("SpectrumSampled_SameAllCoeffWhenRGBisEqual", "spectrum")
{
...
-------------------------------------------------
*/
TEST_CASE("SampledSpectrumInterconversion", "spectrum")
{
    // const float w = 1.0f;
...
-------------------------------------------------
*/
TEST_CASE("SpectrumSampled_WhiteIlluminationIsD65", "spectrum")
{
#if 0
    const float w = 1.0f;
...
-------------------------------------------------
*/
TEST_CASE("SpectrumSampled_SamplingLambda", "spectrum")
{
...
-------------------------------------------------
*/
TEST_CASE("SpectrumSampled_SamplingLambdaHeroWavelength", "spectrum")
{
    for (int32_t ci = 0; ci < 1000; ++ci)
    {
        //
...
-------------------------------------------------
*/
TEST_CASE("sampleHerowavelength1", "spectrum")
{
#if 0
    //
